# WikiLense evaluation: m32_ef_100

Generated 2026-09-22T01:37:12+00:00. 75 claims; 66 with a sentence-only evidence set (the denominator of evidence recall and unit coverage).
...
| configuration | {"chunk_max_words": 120, "chunk_overlap_units": 1, "index_m": 32, "use_prefix": true, "label": "120 words, overlap 1, M=32, prefix on"} |
| eval_seconds | 3.6 |
...
| vector_index_tablespace_bytes | 19922944 |
| chunk_words_mean | 93.8 |
| chunk_words_median | 104.0 |
| chunk_words_p95 | 119.0 |
| chunk_words_max | 174 |
| index_rebuild | {"label": "index_m_sweep_m32", "kind": "rebuild", "m": 32, "m_before": 16, "index_name": "embedding", "drop_sql": "ALTER TABLE chunk DROP INDEX `embedding`", "add_sql": "ALTER TABLE chunk ADD VECTOR INDEX `embedding` (embedding) M=32 DISTANCE=cosine", "drop_seconds": 0.84, "add_seconds": 8.98, "analyze_seconds": 0.003, "vector_index_m_after": 32, "vector_index_distance_after": "cosine", "n_chunks": 8658, "chunk_index_length": 524288, "chunk_data_length": 22593536, "vector_index_tablespace_bytes": 19922944, "rebuilt_at": "2026-09-22T01:37:05+00:00"} |
...
|---|---|---|---|---|---|---|
| 1 | 375 | 0.75 | 0.92 | 0.76 | 0.58 | 1.14 |
| 3 | 375 | 0.70 | 0.89 | 0.72 | 0.52 | 1.41 |
| 5 | 375 | 0.72 | 0.88 | 0.73 | 0.52 | 1.29 |
| 10 | 375 | 0.77 | 0.95 | 0.79 | 0.59 | 1.24 |
| 20 | 375 | 0.91 | 1.08 | 0.92 | 0.72 | 1.61 |
